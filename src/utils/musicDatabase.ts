export type Pacing = "slow" | "flowing" | "urgent" | "building" | "stillness";
export type Mood = "melancholic" | "grief" | "longing" | "serene" | "bittersweet" |
            "searching" | "introspective" | "tense" | "dread" | "unsettled" |
            "ominous" | "desperate" | "urgent" | "primal" | "driven" |
            "inevitable" | "mysterious" | "exotic" | "vast" | "epic" |
            "relentless" | "wrathful" | "triumphant" | "transcendent" |
            "eerie" | "playful" | "romantic" | "hopeful";
...
export const musicDatabase: MusicPiece[] = [
